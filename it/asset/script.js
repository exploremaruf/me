...
function updateLanguageDisplay() {
    ...
    if (currentLangDisplay) {
        currentLangDisplay.textContent = langMap[currentLang] || 'IT';
    }
...
console.log('%cMaruf.Dev Portfolio — Caricato', 'color: #CE2B37; font-size: 14px; font-weight: bold;');
