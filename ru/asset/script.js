...
function updateLanguageDisplay() {
    ...
    if (currentLangDisplay) {
        currentLangDisplay.textContent = langMap[currentLang] || 'RU';
    }
...
console.log('%cMaruf.Dev Portfolio — Загружено', 'color: #CC0000; font-size: 14px; font-weight: bold;');
